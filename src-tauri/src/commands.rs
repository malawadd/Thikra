...
#[cfg_attr(coverage_nightly, coverage(off))]
pub fn set_active_model_legacy(
...
mod tests {
    ...
    fn ollama_chat_request_sends_think_false_explicitly() {
        ...
        assert!(
            ...
            "default options should be omitted"
        );
    }
