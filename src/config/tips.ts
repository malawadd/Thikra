...
export const TIPS: readonly Tip[] = [
  ...
  'Highlight text in any app before summoning Mate to include it as context',
  '/think makes Mate reason step by step before answering, great for hard questions',
  '/search pulls live web results into the chat so answers stay current',
  'Ctrl+W or Esc hides the window; Mate keeps running in the background',
  ...
  'Keep Warm holds your active model ready in VRAM so there is no loading delay when you summon Mate',
  ...
  'Keep Warm in Settings keeps your active model loaded between sessions so Mate is always ready at full speed',
  ...
  'Crank the Context Window slider in Settings up if Mate is forgetting earlier parts of long conversations',
